...
const FEATURES = [
    {
        ...
        description: "DONNA ingests data from Slack, Jira, GitHub, and Confluence to build a complete timeline of every decision, bug, and feature.",
    ...
    },
    {
        ...
        description: "Constructs a dynamic knowledge graph linking code commits to the conversations and decisions that drove them.",
    ...
    },
    {
        ...
        description: "Recognizes patterns of failure in real-time and warns developers before they deploy risky code.",
    ...
    },
    {
        ...
        description: "Ensures that when experts leave, their expertise stays. Instant answers for new hires based on years of context.",
...
const TimelineVisual = () => (
    <div className="relative flex h-full w-full flex-col justify-center gap-4 p-8">
        {[1, 2, 3].map((i) => (
            ...
            >
                <div className={`h-8 w-8 rounded-full flex items-center justify-center ${i === 1 ? 'bg-blue-500/20 text-blue-400' : i === 2 ? 'bg-purple-500/20 text-purple-400' : 'bg-green-500/20 text-green-400'}`}>
                    {i === 1 ? <MessageSquare size={16} /> : i === 2 ? <GitBranch size={16} /> : <FileText size={16} />}
                </div>
...
const ShieldVisual = () => (
    <div className="flex h-full flex-col items-center justify-center gap-6">
        ...
        <div className="space-y-2 text-center">
            ...
            >
                <span className="font-semibold">Alert:</span> Recursive dependency detected
            </motion.div>
        </div>
    </div>
);
        ...
        <main className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans">
            ...
            <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 overflow-hidden">
                ...
                <div className="container relative mx-auto px-6 text-center z-10">
                    ...
                    >
                        Teams repeat mistakes because lessons are buried in chats and tickets. <br className="hidden md:block" />
            ...
            {/* --- Problem Statement --- */}
            <section id="problem" className="border-y border-white/5 bg-neutral-950 py-24">
                <div className="container mx-auto px-6">
                    <div className="mb-16 md:text-center max-w-3xl mx-auto">
                        <h2 className="text-3xl font-semibold tracking-tight md:text-4xl text-white">The "Ignorance Tax"</h2>
                        <p className="mt-4 text-neutral-400 text-lg">
                            When employees leave, the knowledge leaves too. You are paying for the same mistakes over and over again.
                        </p>
                    </div>
            ...
            <section id="solution" className="py-32 bg-black">
                <div className="container mx-auto px-6">
                    <div className="mb-20">
                        <h2 className="text-3xl font-semibold tracking-tight md:text-5xl">How DONNA Works</h2>
                    </div>
                            ...
                            {FEATURES.map((feature) => (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`flex h-8 w-8 items-center justify-center rounded-md transition-colors ${activeFeature === feature.id ? "text-white" : "text-neutral-500"
                                            }`}>
                                            {feature.icon}
                                        </div>
                                        <span className={`text-xs font-bold tracking-widest uppercase ${activeFeature === feature.id ? "text-neutral-400" : "text-neutral-600"
                                            }`}>{feature.subtitle}</span>
                                    </div>
                                    <div className="pl-12">
                                        <h3 className={`text-lg font-semibold transition-colors ${activeFeature === feature.id ? "text-white" : "text-neutral-400"
                                            }`}>{feature.title}</h3>
                                        <div className={`grid transition-all duration-300 ${activeFeature === feature.id ? "grid-rows-[1fr] opacity-100 pt-2" : "grid-rows-[0fr] opacity-0"
                                            }`}>
            ...
            <section id="memory" className="py-32 border-t border-white/5 bg-neutral-950">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
                        <div>
                            <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">Recovered Memories</h2>
